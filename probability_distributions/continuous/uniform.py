...
# ---- FUNCTIONS
#-----------------------------------------------------------------------------#
def cont_u_pdf(x, a = 0, b = 1, include_a = True, include_b = True):
    r"""
...
def cont_u_invcdf(p, a = 0, b = 1):
    ...
    Examples
    ===========
    >>> cont_u_invcdf(0.16379310344827586, 0.6, 12.2)
    2.5

    >>> cont_u_invcdf(0, 0, 1)
    0

    >>> cont_u_invcdf(0.5, 0, 1)
    0.5
...
def cont_u_rvs(a = 0, b = 1, size = 1, seed = None):
    r"""
    ...
    Examples
    ===========
    >>> cont_u_rvs(0, 1, 1, 12345)
    0.41661987254534116
    
    >>> cont_u_rvs(0, 1, 5, 12345)
    [0.41661987254534116,
